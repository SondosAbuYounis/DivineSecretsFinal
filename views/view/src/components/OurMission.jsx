...
export const OurMission = () => {
  ...
  return (
    <section data-aos="zoom-in" className='flex flex-col items-center justify-center justify-items-center bg-[#5C5C42] bg-contain pt-12 pb-12 '>
        <h3 className='text-[4rem] text-[#FEFAF0] scale-100 md:scale-80 sm:scale-50  '>Our Mission</h3>
        <p className='scale-100  md:scale-80 sm:scale-70 sm:max-w-[25rem] md:max-w-[70rem]  text-[#FEFAF0] py-10'>We believe in ethical and smart shopping. All of our products are carefully selected to ensure they align with our core values.</p>
        <div className='scale-100  md:scale-80 sm:scale-70  flex md:flex-row sm:flex-col justify-between gap-24'>
            <div className='flex md:flex-col  flex-wrap justify-center content-center items-center	'> 
