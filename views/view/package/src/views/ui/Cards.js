          ...
          <Table style={{ backgroundColor: '#403F2B20'}} className="no-wrap mt-3 align-middle bg-[#403F2B20]" responsive borderless>
            <thead>
              <tr>
                ...
                <th style={{backgroundColor: 'transparent', color: '#403F2B', height:'3rem', fontFamily:'sans-serif'}} >ُEdit Product</th>
                <th style={{backgroundColor: 'transparent', color: '#403F2B', height:'3rem', fontFamily:'sans-serif'}} >Delete  Product</th>
            ...
            <tbody>
              {data.map((tdata) => (
                <tr  key={tdata.id} style={{borderBottom: '1px solid #403F2B50'}}>
                  ...
                  <td style={{backgroundColor: '#ffffff60'}}><span className="text-muted">{tdata.title}</span>  </td>
                  <td style={{backgroundColor: '#ffffff60'}}><span className="text-muted">{tdata.id}</span>  </td>
